...
@Configuration
@EnableConfigurationProperties({S3Properties.class, KycRekognitionProperties.class})
public class KycRekognitionConfig {

	@Bean
	public RekognitionClient rekognitionClient(
		S3Properties s3Properties,
		KycRekognitionProperties kycRekognitionProperties
	) {
