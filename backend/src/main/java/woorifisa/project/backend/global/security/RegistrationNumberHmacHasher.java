package woorifisa.project.backend.global.security;

import static woorifisa.project.backend.global.response.status.BaseExceptionResponseStatus.REGISTRATION_NUMBER_HMAC_SECRET_NOT_CONFIGURED;
