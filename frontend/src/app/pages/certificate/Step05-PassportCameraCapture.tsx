...
export function PassportCameraCapture() {
      ...
      >
        <div className="space-y-4 pb-2">
          <section className="space-y-2">
            <h2 className="text-2xl font-semibold leading-tight">여권 정보를 수정해 주세요</h2>
  ...
  return (
    ...
    >
      ...
      {cameraError && (
        <div className="mt-4 rounded-xl bg-red-500/20 border border-red-400/40 p-3 text-sm text-center">{cameraError}</div>
      )}
    </CameraCapturePage>
  );
}
