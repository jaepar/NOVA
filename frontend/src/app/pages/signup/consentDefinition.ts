import type { ConsentDefinition } from "../../domains/certificate-consent/spec";
      ...
      terms: [
        {
          ...
          content: [
            ...
            "회원은 서비스 가입 후 본인 확인, 계좌 개설 보조, 금융 생활 지원, 생활 서비스 연계 등 NOVA가 제공하는 기능을 이용할 수 있습니다.",
        ...
        },
        {
          ...
          required: true,
          summary: "회원 식별과 서비스 제공을 위한 필수 개인정보 처리 동의입니다.",
          content: [
            "회사는 회원가입 및 서비스 제공을 위해 이름, 이메일, 생년월일, 성별 등 최소한의 개인정보를 수집 및 이용합니다.",
            "수집된 정보는 회원 식별, 서비스 제공, 고객 지원, 보안 및 부정 이용 방지 목적으로 사용됩니다.",
      ...
      terms: [
        {
          ...
          content: [
            "회사는 이벤트, 프로모션, 맞춤 혜택 및 신규 서비스 안내를 이메일 또는 앱 알림 등으로 제공할 수 있습니다.",
